...
public class Respuesta {
	...
	private List<PersonasRespuesta> persona = null;
	...
	public Respuesta persona(List<PersonasRespuesta> persona) {
		this.persona = persona;
		return this;
	}

	@ApiModelProperty(value = "")
	public List<PersonasRespuesta> getPersona() {
		return persona;
	}

	public void setPersona(List<PersonasRespuesta> persona) {
		this.persona = persona;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.folioConsulta, respuesta.folioConsulta)
				...
				&& Objects.equals(this.empleos, respuesta.empleos) && Objects.equals(this.mensajes, respuesta.mensajes);
	}

	@Override
	public int hashCode() {
		return Objects.hash(folioConsulta, folioConsultaOtorgante, claveOtorgante, declaracionesConsumidor, persona,
				consultas, creditos, domicilios, empleos, mensajes);
	}
