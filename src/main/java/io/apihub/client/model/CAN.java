...
public class CAN {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.identificadorCAN, CAN.identificadorCAN)
				...
				&& Objects.equals(this.fechaMRCAN, CAN.fechaMRCAN) && Objects.equals(this.fechaMACAN, CAN.fechaMACAN);
	}

	@Override
	public int hashCode() {
		return Objects.hash(identificadorCAN, prelacionOrigen, prelacionActual, fechaAperturaCAN, fechaCancelacionCAN,
				historicoCAN, fechaMRCAN, fechaMACAN);
	}
