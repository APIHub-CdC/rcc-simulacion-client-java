package com.cdc.apihub.mx.RCC.simulacion.client.api;
...
import com.cdc.apihub.mx.RCC.simulacion.client.ApiResponse;
import com.cdc.apihub.mx.RCC.simulacion.client.Configuration;
import com.cdc.apihub.mx.RCC.simulacion.client.Pair;
import com.cdc.apihub.mx.RCC.simulacion.client.ProgressRequestBody;
import com.cdc.apihub.mx.RCC.simulacion.client.ProgressResponseBody;
...
import com.cdc.apihub.mx.RCC.simulacion.client.model.Mensajes;
...
public class RCCApi {
	...
	public okhttp3.Call getConsultasCall(String folioConsulta, String xApiKey,
	...
	private okhttp3.Call getConsultasValidateBeforeCall(String folioConsulta, String xApiKey,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
	...
	public okhttp3.Call getCreditosCall(String folioConsulta, String xApiKey,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody = null;
	...
	private okhttp3.Call getCreditosValidateBeforeCall(String folioConsulta, String xApiKey,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		if (folioConsulta == null) {
	...
	public okhttp3.Call getDomiciliosCall(String folioConsulta, String xApiKey,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody = null;
	...
	private okhttp3.Call getDomiciliosValidateBeforeCall(String folioConsulta, String xApiKey,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		if (folioConsulta == null) {
	...
	public ApiResponse<DomiciliosRespuesta> getDomiciliosWithHttpInfo(String folioConsulta, String xApiKey)
			throws ApiException {
		okhttp3.Call call = getDomiciliosValidateBeforeCall(folioConsulta, xApiKey, null, null);
		Type localVarReturnType = new TypeToken<DomiciliosRespuesta>() {
		}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	
	public okhttp3.Call getEmpleosCall(String folioConsulta, String xApiKey,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody = null;
	...
	private okhttp3.Call getEmpleosValidateBeforeCall(String folioConsulta, String xApiKey,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		if (folioConsulta == null) {
	...
	public okhttp3.Call getReporteCall(String xApiKey, PersonaPeticion request, String xFullReport,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
	...
	private okhttp3.Call getReporteValidateBeforeCall(String xApiKey, PersonaPeticion request, String xFullReport,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		if (xApiKey == null) {
	...
	public ApiResponse<Respuesta> getReporteWithHttpInfo(String xApiKey, PersonaPeticion request, String xFullReport)
			throws ApiException {
